...
export default function FacturaExport(props: Props) {
  ...
  const S = {
    ...
    muted: { color: "#7a6c55" } as React.CSSProperties,
    box: {
      background: "#f0ebe0",
      borderRadius: 10,
      padding: "16px 20px",
    ...
    <div style={S.wrap}>
      ...
      <div style={S.header}>
        ...
        <div style={{ textAlign: "right" }}>
          <div style={{ ...S.secTitle, borderBottom: "none", marginBottom: 2 }}>
            N° Factura
          </div>
      ...
      <div style={S.body}>
        ...
        {/* PRODUCTOS */}
        <div>
          <div style={S.secTitle}>Productos / Servicios</div>
          <table
        ...
        <div style={S.box}>
          <div style={S.row}>
            <span style={S.muted}>Subtotal productos</span>
            <span style={{ fontWeight: 600 }}>{fmt(subtotal)}</span>
          </div>
          {saldoAnt !== "" && saldoAnt > 0 && (
            <div style={S.row}>
              <span style={S.muted}>Saldo Anterior</span>
        ...
        {pagos.length > 0 && (
          <div>
            <div style={S.secTitle}>Pagos recibidos</div>
            {pagos.map((p) => (
              <div
                key={p.id}
                style={{
              ...
              >
                ...
                {p.detalle && (
                  <span style={{ ...S.muted, flex: 1, marginLeft: 12 }}>
                    {p.detalle}
                  </span>
                )}
        ...
        {/* CAJAS */}
        <div>
          <div style={S.secTitle}>Movimiento de cajas</div>
